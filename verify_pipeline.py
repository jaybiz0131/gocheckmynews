...
def _boundary_canary():
    ...
    _check(bnd.is_boundary_story(
        "Recall notice: airbag inflator may rupture, covering model years 2019 through 2022",
        "Vehicles built after 1 March 2022 are not covered."), fails,
    ...
    _check(not bnd.is_boundary_story(
        "City council approves a budget of more than $60 million after a long debate",
        "The vote was 8 to 3, and spending rises from version 2 of the draft plan."), fails,
    ...
    _check(not bnd.is_boundary_story(
        "Manufacturer issues a safety notice and names no models yet",
        "The agency said a full notice would follow and gave no further detail."), fails,
...
def _dedupe_guard_canary():
    ...
    _check(_sha == "d5664e24bc8a6a3a", fails,
           f"dedupe: this desk's dedupe.py is {_sha}, the chassis copy is d5664e24bc8a6a3a. "
