...
5. THE OTHER SIDE OF THE STORY: the brief's bear_case items, framed as reported denial,
   ...
   attributed voice, never the desk's. Omitting a bear_case the brief carries reads
   as an advocacy piece. If the brief's bear_case is EMPTY, omit this paragraph
   entirely. Never write about the absence of criticism, never restate
