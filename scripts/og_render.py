...
BRAND_SITE = "News"            # the half that carries the accent
DOMAIN = "gocheckmynews.com"
PROMISE = "Every story sourced. Every source rated."
STRAP = "INDEPENDENT  ·  NO SPIN"
FOOT_NOTE = "Not advocacy. Not advice."
MARK = "columns"               # candles | columns | bracket

PAPER = (251, 250, 246)   # #FBFAF6
INK = (23, 24, 28)        # #17181C
MUTED = (92, 97, 107)     # #5C616B
LINE = (230, 226, 216)    # #E6E2D8
RULE = (29, 78, 121)      # #1D4E79, the accent on paper
