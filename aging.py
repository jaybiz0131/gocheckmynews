#!/usr/bin/env python3
"""
aging.py: the SLOW feedback loop (monthly, REPORT-ONLY). News content ages fast; a
...
PROMPT = """You are the AGING REVIEWER for GoCheckMyNews, running the desk's monthly
...
sources say now (a ruling was overturned, a bill died, charges were dismissed, a figure
was corrected, an "expected" event did not happen)? Unreachable sources are already flagged
